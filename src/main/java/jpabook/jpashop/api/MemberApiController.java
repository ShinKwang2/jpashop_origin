...
public class MemberApiController {
     ...
     *  - 조회V1은 엔티티의 몯느 정보 노출
     *    @JsonIgnore -> 사용하는 것은 최악!(api 는 하나가 아니다.)
     */
     ...
     *      - 엔티티에 API 검증을 윟나 로직이 들어간다. (@NotEmpty 등등)
